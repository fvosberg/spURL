	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_spurl_domain_model_path',
				'foreign_table_where' => 'AND tx_spurl_domain_model_path.pid=###CURRENT_PID### AND tx_spurl_domain_model_path.sys_language_uid IN (-1,0)',
			),
		),
